...
object RecaudacionTestTags {
    ...
    // Paso 1 — OCR de contadores en vivo (T-100). Un escaneo detecta ambos.
    const val OCR_ESCANEAR = "recaudacion_ocr_escanear"
    const val OCR_ESCANER = "recaudacion_ocr_escaner"
    const val OCR_ESCANER_USAR = "recaudacion_ocr_escaner_usar"
