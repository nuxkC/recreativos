...
SELECT is(
    (SELECT count(*) FROM public.audit_log
      WHERE accion = 'instalacion_creada'
        AND entidad_id = 'e0000000-0000-0000-0000-000000000040'),
    1::bigint,
...
SELECT is(
    (SELECT count(*) FROM public.audit_log
      WHERE accion = 'recaudacion_creada'
        AND entidad_id = 'e0000000-0000-0000-0000-000000000050'),
    1::bigint,
...
INSERT INTO public.recaudacion (
    ...
    '[{"denominacion":50,"cantidad":1},{"denominacion":10,"cantidad":1}]'::jsonb,
    '[{"denominacion":20,"cantidad":1},{"denominacion":5,"cantidad":1}]'::jsonb,
    'idem-audit-2', 'recaudacion_anterior', true,
...
SELECT is(
    (SELECT count(*) FROM public.audit_log
      WHERE accion = 'conflicto_detectado'
        AND entidad_id = 'e0000000-0000-0000-0000-000000000051'),
    1::bigint,
...
SELECT is(
    (SELECT count(*) FROM public.audit_log
      WHERE accion = 'cambio_placa_creado'
        AND entidad_id = 'e0000000-0000-0000-0000-000000000060'),
    1::bigint,
