...
export interface Instalacion {
  ...
  createdAt: string;
  updatedAt: string;
  /** Path del boletín de instalación (PDF) en Storage, o null si aún no se ha generado. */
  boletinUrl: string | null;
  /** Marca de tiempo de la última generación del boletín, o null. */
  boletinGeneradoAt: string | null;
...
export interface InstalacionRow {
  ...
  boletin_generado_at: string | null;
  licencia: { id: string; numero: string } | null;
...
export function mapInstalacionRow(row: InstalacionRow): Instalacion {
  return {
    ...
    boletinGeneradoAt: row.boletin_generado_at,
